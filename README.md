...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    useRouteMatch lets access match data without having to render a route/link. You can use the match data to create routes/links that are flexible and don't require you to change the parameters in each url manually.

1. How would you explain form validation to someone who has never programmed before?

    Form validation makes sure that all the information you entered when filling out a form meets the requirements needed to submit a valid form. 
    Example: When you're making an account on a website and it tells you the email or password is not valid, that is form validation.

1. In 1-2 sentences, define end to end testing.

    End to end testing involves testing an apps user experience from beginning to end. It aims to replicate how a user might interact with the app, simulating events such as button clicks, scrolling, submitting forms, etc to make sure everything is working properly.
